      ...
      <div className="relative w-full max-w-[520px] max-h-[85vh] overflow-y-auto border-4 border-black bg-[#fff3d9] p-5 pb-8">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="font-bytebounce text-fluid-xl uppercase leading-none text-[#3e2723]">
              {item.name}
            </h2>
            {item.description && (
              <p className="mt-1.5 font-bytebounce text-fluid-base leading-tight text-[#6d4c41]">
                {item.description}
              </p>
            )}
            <p className="mt-1.5 font-bytebounce text-fluid-md leading-none text-[#8a5a37]">
        ...
        {item.addOns.length > 0 && (
          <div className="mt-4">
            <h3 className="font-bytebounce text-fluid-md uppercase leading-none text-[#3e2723]">
              Add-ons
            </h3>
            <div className="mt-2 space-y-1.5">
              {item.addOns.map((addOn) => (
                ...
                >
                  ...
                  />
                  <span className="min-w-0 flex-1 font-bytebounce text-fluid-base leading-none text-[#3e2723]">
                    {addOn.name}
                  </span>
                  <span className="shrink-0 font-bytebounce text-fluid-base leading-none text-[#8a5a37]">
        ...
        <div className="mt-4 flex items-center gap-3">
          <span className="font-bytebounce text-fluid-md uppercase leading-none text-[#3e2723]">
            Quantity
          </span>
          <div className="flex items-center gap-2">
            <button
              ...
              className="h-9 w-9 border-2 border-[#5d4037] bg-[#f5e0aa] font-bytebounce text-fluid-lg leading-none text-[#3e2723] active:translate-y-0.5"
            >
              −
            </button>
            <span
              aria-live="polite"
              className="w-8 text-center font-bytebounce text-fluid-lg leading-none text-[#3e2723]"
            >
              {quantity}
            </span>
            <button
        ...
        <div className="mt-5 flex items-center gap-3">
          <button
            type="button"
            onClick={onClose}
            className="border-2 border-[#5d4037] bg-[#e0b391] px-4 py-3 font-bytebounce text-fluid-md uppercase leading-none text-[#3e2723] active:translate-y-0.5"
          >
            Cancel
          </button>
          <button
            ...
            className="flex-1 border-2 border-black bg-[#4a7c2f] px-4 py-3 font-bytebounce text-fluid-md uppercase leading-none text-white active:translate-y-0.5"
          >
