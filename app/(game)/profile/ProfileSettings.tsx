...
// Note: avatar customisation is set at registration only. The legacy photo
// upload has been removed; the pixel avatar system (avatarConfig JSONB) is
// the sole display path.
