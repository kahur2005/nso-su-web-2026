      ...
      <div className="game-column min-h-dvh flex flex-col justify-between py-6 px-4">
        <div>
          ...
          <div className="text-center mb-6">
            ...
            <p
              className="mt-1 font-bytebounce text-fluid-sm text-white"
          ...
          {/* Chapter 1: Objective */}
          <div className="mb-5">
            <h2 className="font-bytebounce text-fluid-md text-[#ffd23f] mb-2" style={{ textShadow: '1.5px 1.5px 0 #4e342e' }}>
              ▶ CHAPTER 1: YOUR MISSION
            </h2>
            <div className="rounded-lg border-2 border-[#3a2418] bg-[#fdf6e3] p-3.5">
              <p className="font-bytebounce text-fluid-sm text-[#5d4330] leading-relaxed">
          ...
          {/* Chapter 2: Scanning */}
          <div className="mb-5">
            <h2 className="font-bytebounce text-fluid-md text-[#22c55e] mb-2" style={{ textShadow: '1.5px 1.5px 0 #4e342e' }}>
              ...
              <ol className="space-y-2.5">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2.5">
                    <span className="font-bytebounce text-fluid-xs text-white bg-[#8a5a37] border border-[#3a2418] w-5 h-5 rounded flex items-center justify-center shrink-0">
                      {i + 1}
                    </span>
                    <p className="font-bytebounce text-fluid-sm text-[#5d4330]">
                      {step}
                    </p>
                  </li>
                ))}
          ...
          {/* Chapter 3: Rarities */}
          <div className="mb-5">
            <h2 className="font-bytebounce text-fluid-md text-[#a855f7] mb-2" style={{ textShadow: '1.5px 1.5px 0 #4e342e' }}>
              ▶ CHAPTER 3: NPC RARITIES
            </h2>
            <div className="grid grid-cols-2 gap-2.5">
              {rarities.map((r) => (
                <div key={r.name} className="rounded-lg border-2 border-[#3a2418] bg-[#fdf6e3] p-3 text-center">
                  <p className="font-bytebounce text-fluid-sm" style={{ color: r.color }}>
                    {r.stars}
                  </p>
                  <p className="font-bytebounce text-fluid-base" style={{ color: r.color }}>
                    {r.name}
                  </p>
                  <p className="font-bytebounce text-fluid-xs text-[#8a5a37]">
                    UP TO {r.points}
                  </p>
                </div>
              ))}
          ...
          {/* Chapter 4: Quests */}
          <div className="mb-5">
            <h2 className="font-bytebounce text-fluid-md text-[#3b82f6] mb-2" style={{ textShadow: '1.5px 1.5px 0 #4e342e' }}>
            ...
            <div className="space-y-2">
              {questTypes.map((q) => (
                <div key={q.name} className="rounded-lg border-2 border-[#3a2418] bg-[#fdf6e3] p-3 flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bytebounce text-fluid-base" style={{ color: q.color }}>
                      {q.name}
                    </p>
                    <p className="font-bytebounce text-fluid-xs text-[#5d4330] leading-snug">
                      {q.desc}
                    </p>
                  </div>
                </div>
          ...
          <div className="mb-6">
            <h2 className="font-bytebounce text-fluid-md text-[#ef4444] mb-2" style={{ textShadow: '1.5px 1.5px 0 #4e342e' }}>
              ▶ CHAPTER 5: CODE OF CONDUCT
            </h2>
              ...
              <ul className="space-y-2">
                {conduct.map((rule, i) => (
                  <li key={i} className="flex items-start gap-2">
                    <span className="font-bytebounce text-fluid-sm text-[#ef4444] shrink-0">
                      ❗
                    </span>
                    <p className="font-bytebounce text-fluid-sm text-[#5d4330] leading-relaxed">
                      {rule}
        ...
        <div className="text-center pb-6">
          <Link
            href="/scan"
            className="wood-plank inline-block px-8 py-3 font-bytebounce text-fluid-2xl text-[#ffd23f] active:translate-y-0.5"
