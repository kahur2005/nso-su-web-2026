...
export default function HomePage() {
  ...
  return (
    <main className="flex min-h-dvh w-full items-center justify-center bg-[#000b8c] px-5 py-10">
      <div className="w-full max-w-[clamp(320px,85vw,420px)] overflow-hidden rounded-[10px] bg-white pb-14 shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
        {/* University logos */}
        <div className="flex items-start justify-between px-4 pt-4">
          <div className="flex items-center gap-1.5">
            ...
            />
            <div className="font-campton text-fluid-2xs font-semibold leading-snug tracking-[0.04em]">
        ...
        <div className="bg-[#d2ae65] py-2.5 text-center">
          <p className="font-campton text-fluid-lg font-semibold tracking-[0.02em] text-white">
        ...
        <div className="flex flex-col items-center px-6 pt-6">
          {isLive ? (
            <div className="w-full rounded-lg bg-[#000b8c] py-3 text-center">
              <p className="font-bytebounce text-fluid-md text-[#fbc94c]">
                🎉 NSO IS LIVE!
              </p>
            </div>
          ) : (
            <>
              <p className="mb-3 font-campton text-fluid-xs font-semibold tracking-[0.06em] text-[#667085] uppercase">
        ...
        <div className="px-6 pt-8">
          <Link
            href="/login"
            className="block rounded-[4px] bg-[#000b8c] py-1.5 text-center font-adamina text-fluid-xs tracking-[0.03em] text-white shadow-[0px_4px_4px_rgba(0,0,0,0.25)] transition-colors hover:bg-[#0018c4] active:bg-[#000970]"
          >
            Start your journey!
          </Link>
        </div>
